...
print(f"Q1: le nom de l'etudiant est {etudiant.get("nom")}")
...
print(f"Q6: on a enlevé l'âge de l'étudiant, sa valeur était: {age}")
...
print(f"Q7: Nous avons maintenant {len(etudiant)} paires clés valeurs.")