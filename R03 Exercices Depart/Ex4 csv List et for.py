...
offre_stage = "C:\\Users\\6297003\\Desktop\\R03 Exercices Depart\\csvs\\Ex4 Emplois Reseautique.csv"
...
with open(offre_stage, 'r', encoding= 'utf-8') as Fileread:
    csv_reader = csv.reader(Fileread, delimiter=';')
    next(csv_reader)
