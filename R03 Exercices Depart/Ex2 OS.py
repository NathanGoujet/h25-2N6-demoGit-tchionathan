...
variable = os.environ.get("USERNAME")
...
print(f"Q3{'_'*60}")
os.chdir(os.path.dirname("C:\\Users\\6297003\\Documents\\"))
print(os.getcwd())


# Q4   Imprimez la liste des répertoires et des fichiers qu'il y a dans 'Document'
print(f"Q4{'_'*60}")
for lsrepdoc in os.listdir() :
    print(lsrepdoc)
...
os.chdir("C:\\Users\\6297003\\Documents\\OS-ExercQ6\\")
...
os.chdir("C:\\Users\\6297003\\Documents\\")
os.rmdir("OS-ExercQ6")
print(os.listdir())
